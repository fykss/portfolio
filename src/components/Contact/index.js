...
const contact = () => {
    return (
        <section className='contact d-flex align-content-between flex-column ' id='Contact'>
            ...
            <div className='contact-mail'>
                ...
                <a className='contact-mail-link' href="mailto:fyks1649@gmail.com">fyks1649@gmail.com</a>
            </div>
            ...
            <footer className="footer">
                <span className="footer-copyright text-center text-black-50">Designed and built by Vladyslav Lietun with React</span>
            </footer>
        </section>
    )
};
